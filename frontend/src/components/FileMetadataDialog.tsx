...
interface FileMetadataDialogProps {
  ...
  onSubmit: (data: { filename: string; mimeType: string; size: bigint; hash: string }) => void;
  isLoading: boolean;
}

export default function FileMetadataDialog({ open, onOpenChange, onSubmit, isLoading }: FileMetadataDialogProps) {
      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Record file metadata for this project. This stores information about a file without uploading the file itself.
            </DialogDescription>
          </DialogHeader>
