...
import { useProjects, useCreateProject, useUpdateProject, useDeleteProject, useMyRole, useAssetsByProject } from '@/hooks/useQueries';
...
export default function ProjectsPage() {
  ...
  const handleCreateOrUpdate = async (name: string, description: string) => {
    try {
      ...
      toast.error(error?.message || (editingProject ? 'Failed to update project' : 'Failed to create project'));
    }
  };
      ...
      <div className="mb-8">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage your digital asset projects.</p>
          </div>
          {canMutate && (
